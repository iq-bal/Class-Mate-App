    ...
    setState(() {
      ...
      _filteredAssignments = _assignments.where((assignment) {
        ...
        if (_selectedCourse != null) {
          ...
          matchesCourse = course != null && 
              (course['course_code'] == _selectedCourse || 
        ...
        if (_selectedDate != null) {
          try {
            final assignmentDate = DateTime.parse(assignment['deadline']);
            matchesDate = assignmentDate.year == _selectedDate!.year &&
                         assignmentDate.month == _selectedDate!.month &&
                         assignmentDate.day == _selectedDate!.day;
          } catch (e) {
            matchesDate = false;
          }
        }
